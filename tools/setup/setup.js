...
prompt.get(
  ...
  function(err, result) {
    ...
    function updatePackage() {
      ...
      prompt.get(prompts, function(err1, result1) {
        // parse user responses
        // default values provided for fields that will cause npm to complain if left empty
        const responses = [
          {
            key: 'name',
            value: result1.projectName || 'new-project'
          },
          {
            key: 'version',
            value: result1.version || '0.1.0'
          },
          {
            key: 'author',
            value: result1.author
          },
          {
            key: 'license',
            value: result1.license || 'MIT'
          },
          {
            key: 'description',
            value: result1.description
          },
